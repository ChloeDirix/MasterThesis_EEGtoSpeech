\documentclass[master=ebmt,masteroption=biai]{kulemt}
\setup{
  title={Decoding selective auditory attention from EEG to speech using contrastive learning with transformers},
  author={Chloé Dirix},
  promotor={Prof.\,dr.\,ir.\ Alexander Bertrand},
  assessor={?},
  assistant={dr.\,ir.\ Simon Geirnaert \and dr.\,ir.\ Thomas Strypsteen}}
...
\include{text/intro}
\include{text/chapter-1}
\include{text/chapter-2}
% ... and so on until
\include{text/chapter-n}
