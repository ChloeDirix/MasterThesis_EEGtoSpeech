...
% --TO BE FILLED IN--
\noindent
\textbf{Student name:} Chloé Dirix \hfill \textbf{Student number:} r0887251
...
\textbf{Title Bachelor’s or Master’s thesis:} & Decoding selective auditory attention from EEG to speech using contrastive learning with transformers \\
\end{tabularx}

\vspace{1em}

\textbf{Supervisor:} Alexander Bertrand

\vspace{1em}

\textbf{Daily supervisors:} Simon Geirnaert and Thomas Strypsteen
...
X I \textbf{did use} GenAI Assistance. In this case \textbf{specify which ones} (e.g.\ ChatGPT, M365 Copilot, …): ChatGPT, ...
